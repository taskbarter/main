...
class UserInfo extends Component {
  ...
  setCombox = (month, count) => {
    ...
    for (let i = 0; i < count; i++) {
      str.push(<option value={month[i]}>{month[i]}</option>);
    }
    return str;
  };
  ...
  render() {
    ...
    const errMsg = this.state.errMsg || errors.FName;
    var isLoading = false;
      ...
      <div>
        <form>
          <fieldset>
            ...
            <div className='UserInfoFont'>
              <br />
              We need your contact information to open further
              <br /> opportunities for you{' '}
            </div>
            ...
            <div className='UserInfoFont'>
              <br />
              Your headline help us to find a suitable task for you
            </div>
            <div className='form-group row '>
              <div className='col-sm-3 userInfoLeftMargin'>
                <input
            ...
            <div className='UserInfoFont'>
              Graphic Designer, Developer or Mathematician etc.
              <br />
              <br />{' '}
            </div>
            <div
